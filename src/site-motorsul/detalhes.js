...
const ORG_SLUG = 'motorsul-espumoso'; // mesmo valor do main.js
...
async function iniciar() {
  ...
  document.querySelector('#whatsapp').href =
    `https://wa.me/5554999999999?text=${encodeURIComponent(`Olá! Vi o site e tenho interesse no ${c.marca} ${c.modelo} (${c.preco}). Ainda disponível?`)}`;
