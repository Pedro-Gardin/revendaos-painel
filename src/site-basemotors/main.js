...
//  da Base Motors, mesmo que alguém tente trocar parâmetros
...
const ORG_SLUG = 'base-motors-espumoso';
    ...
    <article class="car-card">
      ...
      <div class="car-info">
        ...
        <div class="card-actions">
          ...
          <a class="button whatsapp-card" href="https://wa.me/5554981461712?text=${msgWpp}" target="_blank" rel="noreferrer">WhatsApp</a>
        </div>
      </div>
    </article>`;
}
